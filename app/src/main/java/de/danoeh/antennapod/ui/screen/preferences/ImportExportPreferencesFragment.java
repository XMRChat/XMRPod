...
public class ImportExportPreferencesFragment extends AnimatedPreferenceFragment {
    ...
    private static final String DEFAULT_OPML_OUTPUT_NAME = "xmrpod-feeds-%s.opml";
    private static final String CONTENT_TYPE_OPML = "text/x-opml";
    private static final String DEFAULT_HTML_OUTPUT_NAME = "xmrpod-feeds-%s.html";
    private static final String CONTENT_TYPE_HTML = "text/html";
    private static final String DEFAULT_FAVORITES_OUTPUT_NAME = "xmrpod-favorites-%s.html";
    private static final String DATABASE_EXPORT_FILENAME = "XMRPodBackup-%s.db";
